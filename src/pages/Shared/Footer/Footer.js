        ...
        <>
            ...
            <Row className="colour ">
                ...
                <Col sm>
                    ...
                    <h1 className="text-color"><i className="icon-color" class="fas fa-phone-square-alt"></i> +999</h1>
                    <h1 className="text-color"><i className="text-color" class="fas fa-mobile-alt"></i> +091748409</h1>
                </Col>
                <Col sm>
                    <h1 className="text-color">Make a Appointment</h1>
                    <Link className="link" to="/appointment"><button className='btn'>Click here</button></Link>
                    <h2 className="text-color">Location</h2>
                    <p className="text-color"> <i class="fas fa-map-marker"></i> Dhanmondi, Dhaka</p>
